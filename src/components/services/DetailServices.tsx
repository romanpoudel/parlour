        ...
        <div>
            <div id="services" className="flex flex-col items-center mt-4">
                <div className="flex flex-col items-center">
                    <p className="absolute right-0 font-mono font-light text-gray-600"><span className="font-bold">&lt;</span>Back</p>
                ...
                <div className="flex flex-row justify-between flex-wrap my-5 gap-5">
                    {
